# Generated by Django 3.2.3 on 2021-05-19 14:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('douban_id', models.CharField(db_column='Douban_id', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imdb_id', models.CharField(db_column='IMDb_id', max_length=63)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imdb_id', models.CharField(db_column='IMDb_id', max_length=26, unique=True)),
                ('title', models.CharField(max_length=125)),
                ('imdb_rating', models.IntegerField(db_column='IMDb_rating')),
                ('tomatoes_rating', models.IntegerField(db_column='Tomatoes_rating')),
                ('douban_rating', models.IntegerField(db_column='Douban_rating')),
                ('ptt_rating', models.IntegerField(db_column='Ptt_rating')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='DoubanDetail',
            fields=[
                ('douban_id', models.CharField(db_column='Douban_id', max_length=16, primary_key=True, serialize=False)),
                ('imdb_id', models.CharField(db_column='IMDb_id', max_length=16)),
